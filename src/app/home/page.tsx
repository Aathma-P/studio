      ...
      <div className="flex flex-1 overflow-hidden md:grid md:grid-cols-[320px_1fr]">
        ...
        <main className="flex flex-1 flex-col overflow-auto">
          ...
          <div className="hidden h-full md:block">
            ...
            {isClient && view === "scan" && <BarcodeScanner onScanSuccess={handleAddItemById} />}
          </div>
          ...
          <div className="relative flex h-full flex-col md:hidden">
            <div className="flex-1 overflow-y-auto pb-16">
              ...
              {isClient && mobileView === "ar" && (
                <ArView
                  items={pendingItems}
                  onItemScannedAndFound={handleToggleItem}
                />
              )}
              {isClient && mobileView === "scan" && <BarcodeScanner onScanSuccess={handleAddItemById} />}
            </div>
